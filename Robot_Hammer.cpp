...
private:
    ...
    const int max_range = 1; // Maximum range of the flamethrower
...
public:
    Robot_Hammer() : RobotBase(2, 5, hammer) 
    {
...
// Factory function to create Robot_Hammer
extern "C" RobotBase* create_robot_hammer() 
{
    return new Robot_Hammer();
}
